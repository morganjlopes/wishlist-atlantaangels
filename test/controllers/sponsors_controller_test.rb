...
class SponsorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sponsor" do
    assert_difference("Sponsor.count") do
      post sponsors_url, params: { sponsor: { address: @sponsor.address, email: @sponsor.email, full_name: @sponsor.full_name, phone: @sponsor.phone } }
    end
  ...
  test "should update sponsor" do
    patch sponsor_url(@sponsor), params: { sponsor: { address: @sponsor.address, email: @sponsor.email, full_name: @sponsor.full_name, phone: @sponsor.phone } }
